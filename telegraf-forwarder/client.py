...
class VRopsClient:
    ...
    """
    Finds a resource based on a query
    
    Paremeters
    ----------
    query:
        A ResourceQuery (see API documentation)
    name:
        The name of the resource, e.g. "reporting-server-01"
    ...
    unit : str, optional
        The unit of the metric if needed to uniquely identify the metric e.g. "CPU|Demand (MHz)" vs "CPU|Demand (%)"
